...
int main()
{
	...
	int stutusButton;
	Button b1 =  {{20, 10, 120, 50}, "Íà÷àòü", RGB(255, 0, 0), RGB(0, 0, 0), RGB(255, 0, 0)};
    Button b2 =  {{20, 60, 120, 100}, "äîìà", RGB(255, 0, 0), RGB(0, 0, 0), RGB(255, 0, 0)};
    Button b5 =  {{20, 110, 120, 150}, "ôîíòàí", RGB(255, 0, 0), RGB(0, 0, 0), RGB(255, 0, 0)};
    Button b8 =  {{20, 160, 120, 200}, "ìàøèíà", RGB(255, 0, 0), RGB(0, 0, 0), RGB(255, 0, 0)};
    Button b10 = {{20, 210, 120, 250}, "ãîñïèòàëü", RGB(255, 0, 0), RGB(0, 0, 0), RGB(255, 0, 0)};
    Button b11 = {{20, 260, 120, 300}, "ñíåãîâèê", RGB(255, 0, 0), RGB(0, 0, 0), RGB(255, 0, 0)};
    Button b12 = {{20, 310, 120, 350}, "åäèíîðîã", RGB(255, 0, 0), RGB(0, 0, 0), RGB(255, 0, 0)};
