...
int main()
{
	...
	buttons[0] = {{20, 10, 120, 50}, "Íŕ÷ŕňü", RGB(255, 0, 0), RGB(0, 0, 0), RGB(255, 0, 0), true};
    buttons[1] = {{20, 60, 120, 100}, "Äîěŕ", RGB(255, 0, 0), RGB(0, 0, 0), RGB(255, 0, 0), true};
    buttons[2] = {{20, 110, 120, 150}, "Ôîíňŕí", RGB(255, 0, 0), RGB(0, 0, 0), RGB(255, 0, 0), true};
    buttons[2] = {{20, 110, 120, 150}, "Äĺęîđ", RGB(255, 0, 0), RGB(0, 0, 0), RGB(255, 0, 0), true};

    buttons[3] = {{20, 160, 120, 200}, "Ěŕřčíŕ", RGB(255, 0, 0), RGB(0, 0, 0), RGB(255, 0, 0), true};
    buttons[4] = {{20, 210, 120, 250}, "Ăîńďčňŕëü", RGB(255, 0, 0), RGB(0, 0, 0), RGB(255, 0, 0), true};
    buttons[5] = {{20, 260, 120, 300}, "Ńíĺăîâčę", RGB(255, 0, 0), RGB(0, 0, 0), RGB(255, 0, 0), true};
    buttons[6] = {{20, 310, 120, 350}, "Ĺäčíîđîă", RGB(255, 0, 0), RGB(0, 0, 0), RGB(255, 0, 0), true};
    ...
    img[4] = {{720,  30, 810, 120}, 36, 26, txLoadImage("img\\fontan.bmp"), true,"Dekor"};
    img[5] = {{770, 140, 800, 170}, 11, 13, txLoadImage("img\\snowmen.bmp"), true,"Dekor"};

    img[6] = {{770, 250, 800, 270}, 17, 9, txLoadImage("img\\car.bmp"), true,"Car"};
    img[7] = {{770, 350, 800, 370}, 16, 10, txLoadImage("img\\car2.bmp"), true,"Car"};
